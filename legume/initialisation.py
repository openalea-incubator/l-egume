...
def init_variables_plantes(ParamP, nbplantes, na):
    ...
    invar = {'SurfPlante': [], 'PARaPlante': [], 'PARiPlante': [], 'PARaPlanteU': [], 'Hplante': [], 'Dplante': [],
             ...
             'ChangeDepth': [], 'RLentotfromRootMass': []}

    for i in range(nbplantes): invar['SurfPlante'].append([]); invar['PARaPlante'].append([]); invar[
        'PARiPlante'].append([]); invar['lsA'].append([]);invar['lsAPrev'].append([]);invar['lsApexMort'].append([])

    for i in range(nbplantes): invar['Hplante'].append(0.); invar['Dplante'].append(0.);invar['RLTot'].append(0.);
    invar['RDepth'].append(0.);invar['parap'].append(0.); invar['parip'].append(0.);invar['PARaPlanteU'].append(0.);
    invar['DiampivMax'].append(0.1); invar['countSh'].append(0);invar['NBsh'].append(0.);invar['NBI'].append(0.);invar[
        'DemandN_Feuil'].append(0.);invar['DemandN_Pet'].append(0.);invar['DemandN_Stem'].append(0.);invar[
        'DemandN_Tot'].append(0.);invar['NBD1'].append(0);invar['NBB'].append(0); invar['countShExp'].append(0);invar[
        'NBBexp'].append(0); invar['R_DemandC_Root'].append(0);invar['RLen1'].append(0);invar['RLen2'].append(0);invar[
        'RLen3'].append(0);invar['RLentot'].append(0);invar['SRL'].append(100.);invar['phmgPet'].append([1.]);invar[
        'phmgEntr'].append([1.]);invar['phmgPet_m'].append([1.]);invar['phmgEntr_m'].append([1.]);invar[
        'firstleaf'].append(float("inf"));invar['MS_aer_cumul'].append(0.); invar['NNI'].append(1.); invar[
        'Ndfa'].append(1.); invar['TT'].append(0.);invar['TTsol'].append(0.);invar['dTT'].append(0.);invar[
        'dTTsol'].append(0.);invar['dMSenFeuil'].append(0.);invar['dMSenTige'].append(0.);invar[
        'R_DemandC_Shoot'].append(1.);invar['DemCp'].append(0.);invar['DemCp_lf'].append(0.);invar['DemCp_in'].append(
        0.);invar['DemCp_pt'].append(0.);invar['MS_pivot'].append(0.);invar['remob'].append(0.);invar[
        'RLTotNet'].append(0); invar['MS_rac_fineNet'].append(0);invar['perteN_rac_fine'].append(0);invar[
        'NBphyto'].append(0);invar['germination'].append(0);invar['dMSgraine'].append(0.);invar['dNgraine'].append(0.);
    invar['NBapexAct'].append(0); invar['NreservPiv'].append(0);invar['rgeq'].append(0);invar['cumtranspi'].append(0.);
    invar['aliveB'].append(0.);invar['isGelDam'].append(0);invar['dMSmortGel_aer'].append(0.);invar[
        'dNmortGel_aer'].append(0.);invar['dTTphyllo'].append(0.);invar['TTphyllo'].append(0.);invar['Udev'].append(0.);
    invar['Udevstress'].append(0.);invar['Udevsol'].append(0.);invar['TTudev'].append(0.);invar['countGelD'].append(
        10.);invar['graineC'].append(0.);invar['graineN'].append(0.);invar['MS_aerienRec'].append(0.);invar[
        'NaerienRec'].append(0.);invar['dMSenPiv'].append(0.);invar['dMSenNonRec'].append(0.);invar[
        'CreservPiv'].append(0);invar['perteN_NonRec'].append(0);invar['perteN_Piv'].append(0);invar[
        'perteN_aerien'].append(0);invar['dMSmortPlant_aer'].append(0);invar['dMSmortPlant_pivot'].append(0);invar[
        'dMSmortPlant_racfine'].append(0);invar['dNmortPlant_aer'].append(0);invar['dNmortPlant_pivot'].append(0);invar[
        'dNmortPlant_racfine'].append(0);invar['alivePiv'].append(0);invar['alive'].append(0);invar[
        'ChangeRoot'].append(0);invar['ChangeDepth'].append(0);invar['RLentotfromRootMass'].append(0);

    PG = array(IOxls.get_lsparami(ParamP, 'PMG')) / 1000.
    invar['MS_graine'] = PG.tolist()
    invar['Mtot'].append(PG.tolist())
    invar['Ngraine'] = array(PG) * array(IOxls.get_lsparami(ParamP, 'Npc_ini')) / 100.
    ...
    # initialisation des compartiments avec des epsilon pour pas que ca bug pas?
    epsilon = 10e-10  # 10e-15
    frac_coty_ini = array(IOxls.get_lsparami(ParamP, 'frac_coty_ini'))  # 0.5 ##a passer en parametre?
    PG = array(PG) * epsilon

    invar['Maerien'].append(array(PG) * frac_coty_ini)  # 4/5 va aerien
    invar['MS_coty'] = array(PG) * frac_coty_ini  # dans les cotyledons
    invar['Mfeuil'].append(array(PG) * frac_coty_ini * 0.98)  # tout aerien dans feuil
    invar['Mtige'].append(array(PG) * frac_coty_ini * 0.01)  #
    invar['Mrac_fine'].append(array(PG) * (1. - frac_coty_ini) * array(IOxls.get_lsparami(ParamP, 'frac_rac_fine')))
    invar['Mpivot'].append(array(PG) * (1. - frac_coty_ini) * (1. - array(IOxls.get_lsparami(ParamP, 'frac_rac_fine'))))
    invar['MS_aerienNonRec'] = array(PG) * frac_coty_ini * 0.01
    invar['Msenaerien'].append(array(PG) * 0.)

    invar['Naerien'] = array(PG) * frac_coty_ini * array(IOxls.get_lsparami(ParamP, 'Npc_ini')) / 100.  # meme teneur racine et shoot
    invar['Ncoty'] = array(PG) * frac_coty_ini * array(IOxls.get_lsparami(ParamP, 'Npc_ini')) / 100.  # meme teneur racine et shoot
    invar['Nrac_fine'] = array(PG) * (1. - frac_coty_ini) * array(IOxls.get_lsparami(ParamP, 'frac_rac_fine')) * array(IOxls.get_lsparami(ParamP, 'Npc_ini')) / 100.  # meme teneur racine et shoot
    invar['Npivot'] = array(PG) * (1. - frac_coty_ini) * (1. - array(IOxls.get_lsparami(ParamP, 'frac_rac_fine'))) * array(IOxls.get_lsparami(ParamP, 'Npc_ini')) / 100.  # meme teneur racine et shoot
    invar['NaerienNonRec'] = array(PG) * frac_coty_ini * 0.01 * array(IOxls.get_lsparami(ParamP, 'Npc_ini')) / 100.
    ...
    for i in range(nbplantes): ls_ftswStress['WaterTreshExpSurf'].append(1.);ls_ftswStress['WaterTreshDevII'].append(
        1.);ls_ftswStress['WaterTreshDevI'].append(1.);ls_ftswStress['WaterTreshFix'].append(1.);ls_ftswStress[
        'WaterTreshRUE'].append(1.);ls_NNIStress['NTreshRUE'].append(1.);ls_NNIStress['NTreshExpSurf'].append(1.);
    ls_NNIStress['NTreshDev'].append(1.);ls_NNIStress['NTreshDevII'].append(1.);ls_TStress['stressTRUE'].append(1.);
...
#sortir init_invar, init_out_var
# bug car par nbplante value dans invar TT